...
import { getNodeTypeIcon, DragHandleIcon } from '@/shared/drag-handle/icons'
...
import { HandleMenu } from '@/shared/handle-menu'
import { EmptyNodeMenu } from '@/shared/empty-node-menu'
